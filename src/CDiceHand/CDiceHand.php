...
class CDiceHand {
   ...
   * Constructor
   *
   * @param int $numDices the number of dices in the hand, defaults to 5 dices. 
   */
  ...
  /**
  * Game over with dice 1
  *
  */
  public function destroy1($n, $m){
         
        if($this->sum == $n){
                 $this->sumRound = $m;
                 $error1 = "<p>Du förlorade! Du slog en {$this->sum}:a. </p>";
                 return $error1;
        }
  }
