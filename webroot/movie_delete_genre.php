...
$miletus['title'] = "Ta bort genre";

$miletus['main'] = <<<EOD
<div id="contentleft">

<h1>Ta bort genre</h1>
<p>Här kan du ta bort de olika filmerna genres. Se i tabellen här nedan villken film du vill ta bort ifrån, skriv in filmens Id i första rutan och välj genres från listan till höger och skriv in dess Id i den andra rutan</p>
